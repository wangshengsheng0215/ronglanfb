...
class CreateProjectWholeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('project_whole', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8';
            ...
            $table->tinyInteger('is_kaip')->comment('是否开票');
    ...
    {
        Schema::dropIfExists('project_whole');
    }
}
